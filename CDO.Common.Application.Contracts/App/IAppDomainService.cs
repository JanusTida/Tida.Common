...
namespace CDO.Common.Application.Contracts.App {
    /// <summary>
    ...
    public interface IAppDomainService:IDisposable {
        ...
        /// </summary>
        /// <returns></returns>
        string GetExecutingAssemblyDirecoty();

        /// <summary>
        /// 获取最近一次通过<see cref="GetExecutingAssemblyDirecoty"/>查询的程序集所在的路径,以提高性能;
        /// </summary>
        string ExecutingAssemblyDirecoty { get; }
    ...
    public class AppDomainService:GenericServiceStaticInstance<IAppDomainService> {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetExecutingAssemblyDirectory() => Current.GetExecutingAssemblyDirecoty();

        /// <summary>
        /// 获取最近一次通过<see cref="GetExecutingAssemblyDirectory"/>查询的程序集所在的路径,以提高性能;
        /// 若尚未查询过,内部将进行查询一次,并返回查询的结果;
        /// </summary>
        public static string ExecutingAssemblyDirectory => Current.ExecutingAssemblyDirecoty;
